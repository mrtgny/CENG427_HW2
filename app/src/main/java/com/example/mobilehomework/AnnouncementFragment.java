...
public class AnnouncementFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        announcementUrl = baseUrl + "/muhendislik/bilgisayar";
        mainView = inflater.inflate(R.layout.announcement_fragment, container, false);
        return mainView;
    }
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Element announcements = doc.select(".caContent").first();
